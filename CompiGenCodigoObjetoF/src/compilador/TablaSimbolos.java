...
public class TablaSimbolos 
{
    ...
    public String buscaComplex( int n )
    {        
        return  arrTabla.get( n ).getComplex( );
    }  
    //--------------------------------------------------------------------------
    ...
    // Fin de sinTipo
     public String buscaParametros( int n )
    {
        return arrTabla.get( n ).getParametros( );
    }
     
    public String buscaTipoMetodo( int n )
    {
        return arrTabla.get( n ).getTipoMetodo();
    }
    
    public String buscaTipoArreglo( int n )
    {
        return arrTabla.get( n ).getTipoArreglo();
    }
    
    //--------------------------------------------------------------------------
     //--------------------------------------------------------------------------
    public void anadeSigUso(int p, int siUso){
        
        arrTabla.get(p).SetSigUso(siUso);
    }
     //--------------------------------------------------------------------------
    public void anadeSigUsoC(String pa, int siUso){
        
        int p=compilador.ts.buscar(pa);
        arrTabla.get(p).SetSigUso(siUso);
    }
    //--------------------------------------------------------------------------
     public int retSigUso(int p){
        return arrTabla.get(p).getSigUso();
    }
